...
export class PaymentComponent implements OnInit, OnDestroy {
  ...
  readonly processingSteps = [
    { icon: '1', label: 'Securing connection...' },
    { icon: '2', label: 'Contacting payment gateway...' },
    { icon: '3', label: 'Verifying transaction...' },
    { icon: '4', label: 'Finalising order...' },
  ];

  /** Payment method options shown as radio buttons */
  paymentMethods = [
    { value: 'UPI',         label: 'UPI',              icon: 'UPI', desc: 'Pay via UPI apps' },
    { value: 'CARD',        label: 'Card',             icon: 'Card', desc: 'Credit / Debit card via Razorpay' },
    { value: 'NET_BANKING', label: 'Net Banking',      icon: 'Bank', desc: 'Internet banking' },
    { value: 'CASH',        label: 'Cash on Delivery', icon: 'COD',  desc: 'Pay on delivery' },
  ];
